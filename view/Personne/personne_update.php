<div class="col-12">
	<form method="POST" action="index.php?page=personne_update&action=update&id=<?php echo $personne['id_personne'];?>">
		<input type="text" name="nom" class="form-control mt-4" placeholder="Nom" value="<?php echo $personne['nom'];?>">
